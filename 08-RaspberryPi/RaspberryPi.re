...
Lチカプログラムは、@<tt>{cl-raspi/src}ディレクトリ下に@<tt>{blink.lisp}という名前で作成してあります。
...
I2C温度センサー制御プログラムは、@<tt>{cl-raspi/src}ディレクトリ下に@<tt>{i2c-temperature-sensor.lisp}という名前で作成してあります。
