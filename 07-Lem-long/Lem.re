...
lisp-modeについての機能を一通り紹介したあと、Lemでの拡張機能の書き方をシンプルなredditのビューアーを作りながら説明していきます。

== Lemで使う用語

以降のチャプターで使うLemで使う用語を確認しておきます。
...
ファイル名は@<tt>{~/.lemrc}または@<tt>{~/.lem.d/init.lisp}です。以下のように書きます。
