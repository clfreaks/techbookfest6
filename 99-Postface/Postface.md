...
**Shibuya.lisp**は渋谷を中心とする半径2万キロをカバーするLisp系言語のコミュニティです。
...
- `https://shibuya.lisp-users.org/`

## 関西Lispユーザー会

**関西Lispユーザー会**は大阪を拠点に、関西のLispユーザの拡大と、ユーザ間での情報共有を目的としたコミュニティです。
...
- 関西Lispユーザー会のconnpassグループページ
  - `https://kansai-lisp-useres.connpass.com/`
