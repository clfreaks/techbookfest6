...
=== lispファイルを編集中にできること。
@<tt>{C-x C-f}で拡張子lispのファイルを開くとlisp用のキーがいくつか使えるようになります。ここでは便利なものを、簡単に紹介します。
...
=== 何かおかしくなったら
ここまでで学んだことは必要最小限の内容なので、操作ミスをしたときに何かおかしいと思ったら、とりあえず@<tt>{C-g}を何回か押すと大体復帰できます。覚えておいて下さい。
